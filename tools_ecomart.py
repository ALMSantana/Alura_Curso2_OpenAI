      ...
      "type": "function",
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "validade": {
                        "type": "string",
                        "description": f"A validade do cupom está em um dos documentos anexados. Caso seja válido e esteja associado as políticas. No formato DD/MM/YYYY.",
                    },
                },
...
def validar_codigo_promocional(argumentos):
    ...
    return f"""Utilize o formato de resposta 
